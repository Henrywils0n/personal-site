...
<template>
  <div class="body">
    ...
    <p>
      In place of a class this summer, I designed an independent study within the history department at Dartmouth in order to explore the digital humanities and oral histories in depth, as well as design my own digital humanities tool for the Dartmouth Digital History Initiative (see more about that <a href="https://ddhi.dartmouth.edu/">here</a> or in the resume tab). 
    </p>
    <p>
